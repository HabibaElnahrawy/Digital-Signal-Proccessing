...
namespace DSPComponentsUnitTest
{
    ...
    public class PracticalTask2TestCases
    {
        ...
        public void PracticalTask2TestCaseECG()
        {
            ...
            var expectedOutput = UnitTestUtitlities.LoadSignal(@"E:\downloads\Package and Task\fcisdsp-dsp.toolbox-78ddd969882b\DSPToolbox\DSPComponentsUnitTest\TestingSignals/FileDown.ds");
